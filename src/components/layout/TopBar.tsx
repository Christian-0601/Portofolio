...
export const TopBar = () => {
  ...
  return (
    <nav className="w-full bg-bg-main/80 backdrop-blur-md border-b border-border-main sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
            {/* Logo */}
            <div className="flex-shrink-0 flex items-center gap-2">
              <Code2 className="text-accent" size={28} />
              <span className="font-bold tracking-tight text-xl text-white">CodeCraft</span>
            </div>
